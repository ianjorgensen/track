# project noname (0.0.1) configured on Sun Jul  1 00:30:59 2012 by
...
[0mld: warning: path '/lib' following -L not a directory
ld: warning: directory not found for option '-L/opt/local/lib'
ld: library not found for -lgif
collect2: ld returned 1 exit status
['/usr/bin/g++', 'Release/test_1.o', '-o', '/Users/ianjorgensen/code/line/one/node_modules/canvas/build/.conf_check_0/testbuild/Release/testprog', '-arch', 'i386', '-L/lib', '-L/usr/lib', '-L/usr/local/lib', '-L/opt/local/lib', '-lgif']
...
collect2: ld returned 1 exit status
['/usr/bin/g++', 'Release/test_1.o', '-o', '/Users/ianjorgensen/code/line/one/node_modules/canvas/build/.conf_check_0/testbuild/Release/testprog', '-arch', 'i386', '-L/lib', '-L/usr/lib', '-L/usr/local/lib', '-L/opt/local/lib', '-ljpeg']
command returned 'Build failed:  -> task failed (err #1): \n\t{task: cxx_link test_1.o -> testprog}'not found

----------------------------------------
Checking for cairo
pkg-config --errors-to-stdout --print-errors --cflags --libs cairo
-I/usr/local/include/cairo -I/usr/local/include/pixman-1 -I/usr/local/include/libpng12  -L/usr/local/lib -lcairo  
yes
